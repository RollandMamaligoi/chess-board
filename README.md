Hello and welcome to my journey of me implementing a chess game in C++.


I used a base abstract class "Piece" as well as derived classes "Pawn", "Bishop", "Knight", "Rook", "Queen" and "King" together with an independent class "Board".
...
Pawn movement: includes diagonal captures, forward movement 1 square and 2 (on first move).
...
Here are some videos of certain scenarios in the game:
...
Pawn Promotion / Black perspective :
